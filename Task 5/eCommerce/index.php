...
use App\Database\Models\Brand_;
use App\Database\Models\Product;

$title = "Home";
include "layouts/header.php";
$brand_ = new Brand_;
$queryResult = $brand_->read();
$Brand_Data = $queryResult->fetch_all(MYSQLI_ASSOC);
?>
...
<body>
    ...
    <!-- Slider End -->
    <!-- Product Area Start -->
    <div class="product-area bg-image-1 pt-50 pb-95">
        <div class="container">
                    ...
                    <div class="col-3">
                        <div class="product-img">
                            <a href="product-details.php">
                                <img alt="" src="assets/img/brand-logo/<?= $brand_Data['image'] ?>">
                            </a>
                        </div>
                        <div class="product-content text-left">
                            <div class="product-hover-style">
                                <div class="product-title">
                                    <h4>
                                        <a href="product-details.php"><?= $brand_Data['name_en'] ?></a>
                                    </h4>
                                </div>
                            </div>
                        </div>
            ...
            <div class="tab-content jump">
                <div class="tab-pane active">
                    <div class="featured-product-active owl-carousel product-nav">
                        <?php
                        $product = new Product;
                        $queryResult = $product->getNewProducts(4);
                        if ($queryResult->num_rows > 0) {
                            $ProductData = $queryResult->fetch_all(MYSQLI_ASSOC);
                            foreach ($ProductData as $Data) { ?>
                                <div class="product-wrapper mb-30">
                                    <div class="product-img">
                                        <a href="product-details.php">
                                            <img alt="" src="assets/img/product/<?= $Data['image'] ?>">
                                        </a>
                                        <span>-30%</span>
                                    ...
                                    <div class="product-content text-left">
                                        <div class="product-hover-style">
                                            <div class="product-title">
                                                <h4>
                                                    <a href="product-details.php"><?= $Data['name_en'] ?></a>
                                                </h4>
                                            </div>
    ...
    <div class="container mt-5">
        <h1 class="text-center ">Most Ordered Products</h1>
        <div class="row mt-5">
            <?php
            $product = new Product;
            $queryResult = $product->getMostOrderedProducts(4);
            if ($queryResult->num_rows > 0) {
                $ProductData = $queryResult->fetch_all(MYSQLI_ASSOC);
                foreach ($ProductData as $Data) { ?>
                    <div class="product-wrapper mb-30 col-3">
                        <div class="product-img">
                            <a href="product-details.php">
                                <img alt="" src="assets/img/product/<?= $Data['image'] ?>">
                            </a>
