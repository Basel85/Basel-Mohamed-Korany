...
$queryResult = $category->read();
$CategoryData = $queryResult->fetch_all(MYSQLI_ASSOC);
                                    ...
                                    <li class="mega-menu-position top-hover"><a href="shop.php">shop</a>
                                        <ul class="mega-menu">
                                            ...
                                            foreach ($CategoryData as $categoryData) { ?>
                                                <li>
                                                    <ul>
                                                        <li class="mega-menu-title"><?= $categoryData['name_en']?></li>
                                                        <?php
                                                           $subcategory->setCategory_id($categoryData['id']);
                                                           $queryResult = $subcategory->getSubcatbyCat();
                                                           $SubcategoryData = $queryResult->fetch_all(MYSQLI_ASSOC);
                                                           foreach($SubcategoryData AS $subcategoryData){?>
                                                                 <li><a href="shop.php"><?=$subcategoryData['name_en']?></a></li>
                                                           <?php
                                                           }
                                                        ?>
                                                    </ul>
