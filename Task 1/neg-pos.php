<?php
   ...
   if($_POST){
    if($_POST['Number']>0){
        $Output="The number {$_POST['Number']} is positive";
    }elseif($_POST['Number']<0){
        $Output="The number {$_POST['Number']} is negative";
    }else{
        $Output="Number Zero is neither negative nor positive";
    }
   }
?>
...
<html lang="en">
  <head>
    <title>Negative-Positive Page</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
